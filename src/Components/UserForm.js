...
function UserForm(props){
    // fnameRef ref will store the first name input box refrence
    let fnameRef = useRef();
    let lnameRef = useRef();
    let emailRef = useRef();
    let pswdRef = useRef();
    ...
    //create an onCreateUser function
    function onCreateUser(event){

        // without this preventdefault when we click on the button then our whole page was reloded so we don't do this to overcome this we use this preventDefault method
        event.preventDefault();
        
        let user = {
            // with the help of that this will store a value which user entered in input box
    ...
    return <>
            <div id="myModal" class="modal">
                    <div class="modal-content">
                        ...
                        <div class="user-form">
                            {/* when use rclick on create user button then onSubmit function will work */}
                            <form onSubmit={onCreateUser}>

                                <div>
                                    {/* with the help of default value when user click on edit button it's detail filled in the input box */}
